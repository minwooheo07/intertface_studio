...
-- ================== 코드매핑 데모 (더존 계정코드 ↔ 빌링 코드) ==================
-- 필드매핑에서 TRANSFORM_RULE = 'CODEMAP:ACCT_CD' 로 지정하면 이 테이블로 치환된다.
-- 매핑에 없는 코드는 원본값을 그대로 유지한다 (데이터 유실 방지).
INSERT INTO CODE_MAP (GROUP_ID, SRC_CODE, TGT_CODE, DESCRIPTION, SORT_ORDER) VALUES ('ACCT_CD', '101', '4001', '매출채권', 1);
INSERT INTO CODE_MAP (GROUP_ID, SRC_CODE, TGT_CODE, DESCRIPTION, SORT_ORDER) VALUES ('ACCT_CD', '102', '4002', '외상매출금', 2);
INSERT INTO CODE_MAP (GROUP_ID, SRC_CODE, TGT_CODE, DESCRIPTION, SORT_ORDER) VALUES ('ACCT_CD', '201', '5001', '상품매출', 3);
